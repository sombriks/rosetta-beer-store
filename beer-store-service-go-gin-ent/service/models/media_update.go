...
func (mu *MediaUpdate) SetDatamedia(b []byte) *MediaUpdate {
	mu.mutation.SetDatamedia(b)
	return mu
}

// SetNomemedia sets the "nomemedia" field.
func (mu *MediaUpdate) SetNomemedia(s string) *MediaUpdate {
	mu.mutation.SetNomemedia(s)
	return mu
}

// SetMimemedia sets the "mimemedia" field.
func (mu *MediaUpdate) SetMimemedia(s string) *MediaUpdate {
	mu.mutation.SetMimemedia(s)
	return mu
}
...
func (mu *MediaUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mu.mutation.Creationdatemedia(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: media.FieldCreationdatemedia,
		})
	}
	if value, ok := mu.mutation.Datamedia(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeBytes,
			Value:  value,
			Column: media.FieldDatamedia,
		})
	}
	if value, ok := mu.mutation.Nomemedia(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: media.FieldNomemedia,
		})
	}
	if value, ok := mu.mutation.Mimemedia(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: media.FieldMimemedia,
		})
	}
...
// SetCreationdatemedia sets the "creationdatemedia" field.
func (muo *MediaUpdateOne) SetCreationdatemedia(t time.Time) *MediaUpdateOne {
	muo.mutation.SetCreationdatemedia(t)
	return muo
}

// SetDatamedia sets the "datamedia" field.
func (muo *MediaUpdateOne) SetDatamedia(b []byte) *MediaUpdateOne {
	muo.mutation.SetDatamedia(b)
	return muo
}

// SetNomemedia sets the "nomemedia" field.
func (muo *MediaUpdateOne) SetNomemedia(s string) *MediaUpdateOne {
	muo.mutation.SetNomemedia(s)
	return muo
}

// SetMimemedia sets the "mimemedia" field.
func (muo *MediaUpdateOne) SetMimemedia(s string) *MediaUpdateOne {
	muo.mutation.SetMimemedia(s)
	return muo
}
...
func (muo *MediaUpdateOne) sqlSave(ctx context.Context) (_node *Media, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`models: missing "Media.id" for update`)}
	}
	...
	if value, ok := muo.mutation.Datamedia(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeBytes,
			Value:  value,
			Column: media.FieldDatamedia,
	...
	if value, ok := muo.mutation.Nomemedia(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: media.FieldNomemedia,
	...
	if value, ok := muo.mutation.Mimemedia(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: media.FieldMimemedia,
