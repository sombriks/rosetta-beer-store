...
import (
	...
	"github.com/sombriks/rosetta-beer-store/beer-store-service-go-gin-ent/service/models"
)

// The BeerFunc type is an adapter to allow the use of ordinary
// function as Beer mutator.
type BeerFunc func(context.Context, *models.BeerMutation) (models.Value, error)

// Mutate calls f(ctx, m).
func (f BeerFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	mv, ok := m.(*models.BeerMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *models.BeerMutation", m)
	}
	return f(ctx, mv)
}
...
type MediaFunc func(context.Context, *models.MediaMutation) (models.Value, error)

// Mutate calls f(ctx, m).
func (f MediaFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	mv, ok := m.(*models.MediaMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *models.MediaMutation", m)
	}
	return f(ctx, mv)
}
