...
func (mgb *MediaGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("models: MediaGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MediaGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("models: MediaGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MediaGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("models: MediaGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MediaGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("models: MediaGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MediaGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("models: MediaGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MediaGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("models: MediaGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MediaGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("models: MediaGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MediaGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("models: MediaGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MediaSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("models: MediaSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MediaSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("models: MediaSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MediaSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("models: MediaSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MediaSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("models: MediaSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MediaSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("models: MediaSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MediaSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("models: MediaSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MediaSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("models: MediaSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MediaSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("models: MediaSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
